...
<template>
  <header class="sticky top-0 z-50 hidden h-20 w-full select-none justify-center border-b border-catppuccin-800 bg-catppuccin-950/50 backdrop-blur-sm sm:flex">
